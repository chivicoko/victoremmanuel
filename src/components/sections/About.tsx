        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-start">
          ...
          <div>
            ...
            <h2 className="section-title mb-8">
              Building the future, <em>one component at a time.</em>
            </h2>
            ...
            >
              &ldquo;My mission is to create digital experiences that are not
              just functional, but truly delightful — products that users love
              to use and developers love to maintain.&rdquo;
            </blockquote>
          </div>
