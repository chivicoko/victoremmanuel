    ...
    >
      <div className="max-w-300 mx-auto px-6 md:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="mt-4 text-muted-foreground max-w-130 mx-auto text-[0.9375rem] leading-[1.75]">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-4xl mx-auto">
          ...
          >
            <form className="space-y-5" onSubmit={handleSubmit}>
              <div>
                <label className="block text-base font-display font-semibold tracking-widest uppercase text-muted-foreground mb-2">
                  Name
                </label>
                <input
                  type="text"
                  ...
                  style={inputStyle}
                  onFocus={(e) => {
                    e.target.style.borderColor = "#e8a44a";
                    e.target.style.boxShadow =
                      "0 0 0 3px rgba(232,164,74,0.08)";
                  }}
                  onBlur={(e) => {
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              <h3 className="font-display font-bold mb-5 text-foreground">
                Contact Information
              </h3>
              <div className="space-y-1">
                {contactInfo.map((item, i) => (
                  ...
                  >
                    ...
                    <div>
                      <div className="text-base text-muted-foreground/60 mb-0.5">
                        {item.label}
                      </div>
